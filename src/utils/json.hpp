...
//  c2
//
//  Imported by Six on 1/16/2020.
//

////////////////////////////////////////////////////////////////////////////////
/// This file was imported from the simpleson github project:
///
///              https://github.com/gregjesl/simpleson
///
/// The license file at the time of duplication was the standard MIT license.
/// The copyright holder is: Copyright (c) 2018 Gregory Eslinger.
///
/// Thanks for the excellent code, Gregory!
////////////////////////////////////////////////////////////////////////////////

/// Original simpleson code follows.
#ifndef JSON_H
#define JSON_H
